	...
	return z
		.object({
			...
			*/
			 ...
			 */
			Head: z.string().default('@okzyrox/moonlight/components/Head.astro'),
			 ...
			 */
			ThemeProvider: z.string().default('@okzyrox/moonlight/components/ThemeProvider.astro'),
			...
			*/
			 ...
			 */
			SkipLink: z.string().default('@okzyrox/moonlight/components/SkipLink.astro'),
			...
			*/
			 ...
			 */
			PageFrame: z.string().default('@okzyrox/moonlight/components/PageFrame.astro'),
			/**
			 ...
			 */
			MobileMenuToggle: z.string().default('@okzyrox/moonlight/components/MobileMenuToggle.astro'),
			 ...
			 */
			TwoColumnContent: z.string().default('@okzyrox/moonlight/components/TwoColumnContent.astro'),
			...
			*/
			 ...
			 */
			Header: z.string().default('@okzyrox/moonlight/components/Header.astro'),
			/**
			 ...
			 */
			SiteTitle: z.string().default('@okzyrox/moonlight/components/SiteTitle.astro'),
			/**
			 ...
			 */
			Search: z.string().default('@okzyrox/moonlight/components/Search.astro'),
			/**
			 ...
			 */
			SocialIcons: z.string().default('@okzyrox/moonlight/components/SocialIcons.astro'),
			/**
			 ...
			 */
			ThemeSelect: z.string().default('@okzyrox/moonlight/components/ThemeSelect.astro'),
			/**
			 ...
			 */
			LanguageSelect: z.string().default('@okzyrox/moonlight/components/LanguageSelect.astro'),
			...
			*/
			 ...
			 */
			Sidebar: z.string().default('@okzyrox/moonlight/components/Sidebar.astro'),
			/**
			 ...
			 */
			MobileMenuFooter: z.string().default('@okzyrox/moonlight/components/MobileMenuFooter.astro'),
			...
			*/
			 ...
			 */
			PageSidebar: z.string().default('@okzyrox/moonlight/components/PageSidebar.astro'),
			/**
			 ...
			 */
			TableOfContents: z.string().default('@okzyrox/moonlight/components/TableOfContents.astro'),
			/**
			...
			MobileTableOfContents: z
				.string()
				.default('@okzyrox/moonlight/components/MobileTableOfContents.astro'),
			...
			*/
			 ...
			 */
			Banner: z.string().default('@okzyrox/moonlight/components/Banner.astro'),
			 ...
			 */
			ContentPanel: z.string().default('@okzyrox/moonlight/components/ContentPanel.astro'),
			 ...
			 */
			PageTitle: z.string().default('@okzyrox/moonlight/components/PageTitle.astro'),
			...
			FallbackContentNotice: z
				.string()
				.default('@okzyrox/moonlight/components/FallbackContentNotice.astro'),
			...
			DraftContentNotice: z
				.string()
				.default('@okzyrox/moonlight/components/DraftContentNotice.astro'),
			 ...
			 */
			Hero: z.string().default('@okzyrox/moonlight/components/Hero.astro'),
			...
			*/
			 ...
			 */
			MarkdownContent: z.string().default('@okzyrox/moonlight/components/MarkdownContent.astro'),
			...
			*/
			 ...
			 */
			Footer: z.string().default('@okzyrox/moonlight/components/Footer.astro'),
			/**
			 ...
			 */
			LastUpdated: z.string().default('@okzyrox/moonlight/components/LastUpdated.astro'),
			/**
			 ...
			 */
			Pagination: z.string().default('@okzyrox/moonlight/components/Pagination.astro'),
			/**
			 ...
			 */
			EditLink: z.string().default('@okzyrox/moonlight/components/EditLink.astro'),
		})
		.prefault({});
}
